...
2. [ ] **Video handling — the general pass** — the DT Project Browser part is done (see Completed). Still open: expanding a clip in place to page through its frames, and a wider look at how series are handled outside the browser
